...
def GetDCCurrent(numDC,numCM=1):    
    ...
    for i in xrange(numDC):
        ...
        #iDCHTmp=np.random.random()  #    
        iDCHTmp=caget(nameDC_H)  
        #iDCVTmp=np.random.random()  #    
...
def GetBPM(idStart=5,idEnd=10):
    ...
    for i in range(idStart,idEnd+1):
        ...
        #xBPMTmp=np.random.random()   # 
        xBPMTmp=caget(xNameBPM)
        #yBPMTmp=np.random.random()   # 
...
def GetSolenoidCurren(numDC,numCM=1):
    ...
    for i in range(numDC):
        ...
        #iSolenTmp=np.random.random()   # 
        iSolenTmp=caget(nameSol)
