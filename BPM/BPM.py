...
with open(nameRec,'a+') as fid:
	...
	if iTotal==1:
        ...
        strWrite=str(cHV).replace('\n','')[1:-1:]+' '+ str(np.round(xBpm*100.)/100).replace('\n','')[1:-1:]+'  '  + str(np.round(yBpm*100.)/100).replace('\n','')[1:-1:]+'  '+str(Q1)+'  '+str(Q2)+'  '+str(Q3)+'  '+str(Q4)+'  '+str(Q5)+'  '+str(Q6)+str(Q7)+'  '+str(dCH1-15.)+'  '+str(dCH2-15.)+'  '+str(dCH3-15.)+'  '+str(dCH4-15.)+'  '+str(dCH5-15.)+'  '+str(dCH6-15.)+str(dCH7-15.)+'  '+str(dCV1-15.)+'  '+str(dCV2-15.)+'  '+str(dCV3-15.)+'  '+str(dCV4-15.)+'  '+str(dCV5-15.)+'  '+str(dCV6-15.)+str(dCV7-15.)+'  '+str(acct1)+'  '+str(acct2)+'  '+str(acct3)+'\n'
	if flagHVWrite==0:
