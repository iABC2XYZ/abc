...
for iEpoch in range(np.int32(numEpoch)):
    ...
    if iEpoch % numPlotStep==0:
        ...
        xBPMEx_12=np.vstack((xBPMEx_1,xBPMEx_2))
        xBPMEx_12_2=-xBPMEx_12
        xBPMEx_12_2[:,0]=-1.86408430966,1.38253433488
        
        xBPMEx=np.hstack((xBPMEx_12_2,xBPMEx_12))
