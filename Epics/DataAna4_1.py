...
wFC6= GenWeight([sizeLayer[5],sizeLayer[6]])
bFC6=GenBias([sizeLayer[6]])   


wFC7= GenWeight([sizeLayer[6],sizeLayer[7]])
bFC7=GenBias([sizeLayer[7]])   
...
xAct5=tf.atan(xFC5)
xFC6=tf.matmul(xAct5,wFC6)+bFC6
xAct6=tf.atan(xFC6)
xFC7=tf.matmul(xAct6,wFC7)+bFC7
